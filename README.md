...
| **小米Mimo (Mimo)** | MiMo-V2.5 | 小米自研AI模型，支持图片理解，越级全模态 Agent，百万上下文，多模态能力强，其中MiMo-V2.5为**顶尖OCR模型**，中文识别**非常优秀**，**十分推荐**|
...
3. 默认API地址：`https://api.xiaomimimo.com/v1`
4. 如购买了Code套餐，可使用专属地址：`https://token-plan-cn.xiaomimimo.com/v1`
